...
export default function Footer() {
  return (
    <footer className="bg-black text-white dark:bg-background pt-16 md:pt-20 pb-4 px-6 md:px-10 lg:px-20">
      <div className="text-5xl md:text-7xl lg:text-9xl text-center font-fraunces pb-10 break-words">WHAT NXT.</div>
      ...
      <div className="flex flex-col md:flex-row justify-between pt-12 md:pt-20 pb-12 md:pb-20 gap-12 md:gap-8 lg:gap-0">
        <div className="space-y-6 md:max-w-xs">
          <h4 className="text-white/40 text-sm font-medium tracking-wider">A BRAND & DIGITAL PRODUCT STUDIO</h4>
        ...
        <div className="flex flex-col gap-5">
          <h4 className="text-white/40 text-sm font-medium tracking-wider mb-2 md:mb-0">LINKS</h4>
          <Link href="/" className="hover:text-accent transition-colors">WORK</Link>
        ...
        <div className="flex flex-row md:flex-col gap-4 md:gap-5 md:pr-10 lg:pr-20">
          <Link href="/" className="bg-accent px-4 py-4 md:px-3 md:py-3 rounded-full hover:bg-white hover:text-black transition-colors group">
            <svg
              role="img"
              viewBox="0 0 24 24"
