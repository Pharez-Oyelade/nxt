    ...
    <div className="flex-1 p-4 md:p-8 pt-6 space-y-6 max-w-7xl mx-auto w-full">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px]">
          <p className="text-destructive font-medium mb-4">Failed to load clients.</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] border border-dashed border-border/60 rounded-2xl bg-card">
          ...
          <h3 className="text-xl font-semibold text-primary">No clients found</h3>
          <p className="text-sm text-muted-foreground mt-1 mb-6 text-center max-w-sm">
            You don't have any clients yet. Convert a lead or manually add one here.
          </p>
          <Link
            href="/admin/clients/new"
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-1.5 text-foreground">
                          ...
                          {client.primaryContactName || <span className="italic text-muted-foreground/50">Not set</span>}
                        </div>
